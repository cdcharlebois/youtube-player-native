import React from "@widget/react-native-youtube/node_modules/react";
import PropTypes from "@widget/react-native-youtube/node_modules/prop-types";
import ReactNative, {
    View,
    ViewPropTypes,
    Text,
...
export default class YouTube extends React.Component {
    ...
    getVideosIndex = () =>
        NativeModules.YouTubeModule.getVideosIndex(ReactNative.findNodeHandle(this._nativeComponentRef.current));

    getCurrentTime = () =>
        NativeModules.YouTubeModule.getCurrentTime(ReactNative.findNodeHandle(this._nativeComponentRef.current));

    getDuration = () =>
        NativeModules.YouTubeModule.getDuration(ReactNative.findNodeHandle(this._nativeComponentRef.current));
        ...
        return (
            <View onLayout={this._onLayout} style={[styles.container, this.props.style]}>
                <RCTYouTube
                    ...
                    style={[styles.module, { marginRight: this.state.resizingHackFlag ? StyleSheet.hairlineWidth : 0 }]}
